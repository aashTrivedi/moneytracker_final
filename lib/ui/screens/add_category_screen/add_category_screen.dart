                ...
                return ElevatedButton(
                    ...
                    onPressed: !state.selectedIcon.iconId.isNegative &&
                        ...
                        ? () {
                            ...
                            buildShowSnackBar(context, "add Catagory");
                    }
                        : null,
                    child: SizedBox(
                      width: MediaQuery.of(context).size.width * 0.9,
                      child: Center(
                          heightFactor: 1, child: Text("Catagory"
                          )),
                    ));
              },
            ),
