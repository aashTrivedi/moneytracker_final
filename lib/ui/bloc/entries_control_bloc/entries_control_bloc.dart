...
import 'package:moneytracker/domain/models/balance_model/balance.dart';
import 'package:moneytracker/domain/models/category_icon_model/category_icon.dart';
import 'package:moneytracker/domain/models/entry_category_model/entry_category.dart';
import 'package:moneytracker/domain/models/entry_date_model/entry_date.dart';
import 'package:moneytracker/domain/models/entry_model/entry.dart';
import 'package:moneytracker/domain/models/statistics_element_model/statistics_element.dart';
import 'package:moneytracker/domain/repository/database_repository.dart';
...
class EntriesControlBloc
  ...
  EntriesControlBloc(this.databaseRepository)
   ...
   on<deleteCategoryEvent>((event, emit) async {
      await databaseRepository.deleteCategory(
          categoryId: state.categoryToAdd.categoryId,
          );
      add(InitialDatabaseEvent());
      add(CallEntryCategoriesEvent());
