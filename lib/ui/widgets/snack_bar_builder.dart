...
ScaffoldFeatureController<SnackBar, SnackBarClosedReason>? buildShowSnackBar
  ...
  return moneytrackerApp.rootScaffoldMessengerKey.currentState?.showSnackBar(SnackBar(
    ...
    content: Row(
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            moneytrackerApp.rootScaffoldMessengerKey.currentState?.hideCurrentSnackBar();
          },
          child: const Icon(
            Icons.close,
            color: Colors.white,
